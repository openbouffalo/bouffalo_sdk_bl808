...
#else /* typeC/QSPI */
#define LCD_DBI_CLOCK_LIMIT (80 * 1000 * 1000)
#endif
#else
/* Bus clock: 80M */
#if (LCD_DBI_WORK_MODE == 3) /* typeB */
#define LCD_DBI_CLOCK_LIMIT (27 * 1000 * 1000)
#else /* typeC/QSPI */
#define LCD_DBI_CLOCK_LIMIT (40 * 1000 * 1000)
#endif
#endif
...
int lcd_dbi_init(lcd_dbi_init_t *dbi_parra)
{
    ...
    /* clock frequency limit */
    if (dbi_cfg.clk_freq_hz > LCD_DBI_CLOCK_LIMIT) {
        dbi_cfg.clk_freq_hz = LCD_DBI_CLOCK_LIMIT;
    }
