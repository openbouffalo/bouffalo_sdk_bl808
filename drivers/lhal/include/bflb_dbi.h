...
/** @defgroup DBI_PIXEL_INPUT_FORMAT dbi fifo input pixel format, the FIFO are filled in 32-bits width definition
  * @{
  */
#define DBI_PIXEL_INPUT_FORMAT_NBGR_8888 \
    0 /* 32-bit/pixel, memory byte: [0]->pixel[0][R], [1]->pixel[0][G], [2]->pixel[0][B], [3]->invalid, [4]->pixel[1][R], ... */
#define DBI_PIXEL_INPUT_FORMAT_NRGB_8888 \
    1 /* 32-bit/pixel, memory byte: [0]->pixel[0][B], [1]->pixel[0][G], [2]->pixel[0][R], [3]->invalid, [4]->pixel[1][B], ... */
#define DBI_PIXEL_INPUT_FORMAT_BGRN_8888 \
    2 /* 32-bit/pixel, memory byte: [0]->invalid, [1]->pixel[0][R], [2]->pixel[0][G], [3]->pixel[0][B], [4]->invalid, [5]->pixel[1][R], ... */
#define DBI_PIXEL_INPUT_FORMAT_RGBN_8888 \
    3 /* 32-bit/pixel, memory byte: [0]->invalid, [1]->pixel[0][B], [2]->pixel[0][G], [3]->pixel[0][R], [4]->invalid, [5]->pixel[1][B], ... */
#define DBI_PIXEL_INPUT_FORMAT_BGR_888 \
    4 /* 24-bit/pixel, memory byte: [0]->pixel[0][R], [1]->pixel[0][G], [2]->pixel[0][B], [3]->pixel[1][R], [4]->pixel[1][G], ... */
#define DBI_PIXEL_INPUT_FORMAT_RGB_888 \
    5 /* 24-bit/pixel, memory byte: [0]->pixel[0][B], [1]->pixel[0][G], [2]->pixel[0][R], [3]->pixel[1][B], [4]->pixel[1][G], ... */
#define DBI_PIXEL_INPUT_FORMAT_BGR_565 6 /* 16-bit/pixel, */
#define DBI_PIXEL_INPUT_FORMAT_RGB_565 7 /* 16-bit/pixel, */
#define DBI_PIXEL_INPUT_FORMAT_NVUY \
    8 /* 32-bit/pixel, memory byte: [0]->pixel[0][Y], [1]->pixel[0][U], [2]->pixel[0][V], [3]->invalid, [4]->pixel[1][Y], ... */
#define DBI_PIXEL_INPUT_FORMAT_NYUV \
    9 /* 32-bit/pixel, memory byte: [0]->pixel[0][V], [1]->pixel[0][U], [2]->pixel[0][Y], [3]->invalid, [4]->pixel[1][V], ... */
#define DBI_PIXEL_INPUT_FORMAT_VUYN \
    10 /* 32-bit/pixel, memory byte: [0]->invalid, [1]->pixel[0][Y], [2]->pixel[0][U], [3]->pixel[0][V], [4]->invalid, [5]->pixel[1][Y], ... */
#define DBI_PIXEL_INPUT_FORMAT_YUVN \
    11 /* 32-bit/pixel, memory byte: [0]->invalid, [1]->pixel[0][V], [2]->pixel[0][U], [3]->pixel[0][Y], [4]->invalid, [5]->pixel[1][V], ... */
#define DBI_PIXEL_INPUT_FORMAT_VUY444 \
    12 /* 24-bit/pixel, memory byte: [0]->pixel[0][Y], [1]->pixel[0][U], [2]->pixel[0][V], [3]->pixel[1][Y], [4]->pixel[1][U], ... */
#define DBI_PIXEL_INPUT_FORMAT_YUV444 \
    13 /* 24-bit/pixel, memory byte: [0]->pixel[0][V], [1]->pixel[0][U], [2]->pixel[0][Y], [3]->pixel[1][V], [4]->pixel[1][U], ... */
#define DBI_PIXEL_INPUT_FORMAT_YUYV \
    14 /* 16-bit/pixel, memory byte: [0]->pixel[0][Y], [1]->pixel[0/1][U], [2]->pixel[1][Y], [3]->pixel[0/1][V], [4]->pixel[2][Y], ... */
#define DBI_PIXEL_INPUT_FORMAT_YVYU \
    15 /* 16-bit/pixel, memory byte: [0]->pixel[0][Y], [1]->pixel[0/1][V], [2]->pixel[1][Y], [3]->pixel[0/1][U], [4]->pixel[2][Y], ... */
#define DBI_PIXEL_INPUT_FORMAT_UYVY \
    16 /* 16-bit/pixel, memory byte: [0]->pixel[0/1][U], [1]->pixel[0][Y], [2]->pixel[0/1][V], [3]->pixel[1][Y], [4]->pixel[2/3][U], ... */
#define DBI_PIXEL_INPUT_FORMAT_VYUY \
    17 /* 16-bit/pixel, memory byte: [0]->pixel[0/1][V], [1]->pixel[0][Y], [2]->pixel[0/1][U], [3]->pixel[1][Y], [4]->pixel[2/3][V], ... */
/**
  * @}
  */
...
// clang-format off
/* QSPI mode (DBI_MODE_EX_QSPI) is only available on chips with
   DBI_QSPI_SUPPORT, so the valid modes end at Type C 3-wire either way */
#define IS_DBI_MODE(type)      ((type) <= DBI_MODE_TYPE_C_3_WIRE)

#define IS_DBI_PIXEL_INPUT_FORMAT(type)      ((type) <= DBI_PIXEL_INPUT_FORMAT_VYUY)
